...
import { BoardArticle, BoardArticles } from '../../libs/dto/article/article';
import { AllBoardArticlesInquiry, BoardArticleInput, BoardArticlesInquiry } from '../../libs/dto/article/article.input';
import { BoardArticleUpdate } from '../../libs/dto/article/article.update';
